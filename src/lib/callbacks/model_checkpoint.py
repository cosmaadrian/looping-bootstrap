...
class ModelCheckpoint(Callback):
    ...
    def on_epoch_end(self):
        ...
        if self.save_best_only:
            ...
            path = os.path.join(self.dirpath, self.filename.format(**{'epoch': self.trainer.epoch, self.monitor: trainer_quantity, 'global_step': self.trainer.global_step}))
        else:
            path = os.path.join(self.dirpath, self.filename.format(**{'epoch': self.trainer.epoch, 'global_step': self.trainer.global_step}))
