...
class AcumenDataset(Dataset):
    ...
    def train_dataloader(cls, args, annotations = None):
        ...
        return DataLoader(dataset, num_workers = args.environment.extra_args.num_workers if not args.debug else 1, pin_memory = True, shuffle = True, batch_size = args.batch_size)
